...
from getNewMcp import get_new_mcp as find_mcp, install_missing_mcp_server
...
@mcp.tool()
def get_missing_mcp_server(server_name: str) -> Dict[str, Any]:
    """
    ...
    """
    return install_missing_mcp_server(server_name, False)
